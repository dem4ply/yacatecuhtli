...
class Test_api_country_no_autentificate( APITestCase ):
	...
	def test_detail( self, *args ):
		url = reverse( 'person:country-detail', kwargs={
			'format': 'json',
			'pk': 1,
		} )
		# no deberia de ser valido porque no se a autentificado el usuario
...
class Test_api_country_authorize( APITestCase ):
	"""
