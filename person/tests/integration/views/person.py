...
class Test_api_person_no_autentificate( APITestCase ):
	...
	def test_detail( self, *args ):
		url = reverse( 'person:person-detail', kwargs={
			'format': 'json',
			'pk': 1,
		} )
		# no deberia de ser valido porque no se a autentificado el usuario
...
class Test_api_person_authorize( APITestCase ):
	"""
